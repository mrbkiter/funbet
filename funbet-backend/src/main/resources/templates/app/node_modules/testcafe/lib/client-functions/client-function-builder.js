...
var _ensureDeprecatedOptions = require('./selector-builder/ensure-deprecated-options');

var _ensureDeprecatedOptions2 = _interopRequireDefault(_ensureDeprecatedOptions);
...
var ClientFunctionBuilder = function () {
    ...
    ClientFunctionBuilder._resolveContextTestRun = function _resolveContextTestRun() {
    ...
    ClientFunctionBuilder.prototype._decorateFunction = function _decorateFunction(clientFn) {
        ...
        clientFn.with = function (options) {
            (0, _ensureDeprecatedOptions2.default)('with', options);
    ...
    ClientFunctionBuilder.prototype.getFunction = function getFunction() {
        ...
        var clientFn = function __$$clientFunction$$() {
            var testRun = builder.options.boundTestRun ? builder.options.boundTestRun.testRun : ClientFunctionBuilder._resolveContextTestRun();
    ...
    ClientFunctionBuilder.prototype._validateOptions = function _validateOptions(options) {
        (0, _typeAssertions.assertNonNullObject)(this.callsiteNames.instantiation, '"options" argument', options);
        ...
        if (!(0, _lodash.isNil)(options.dependencies)) (0, _typeAssertions.assertObject)(this.callsiteNames.instantiation, '"dependencies" option', options.dependencies);
    };
