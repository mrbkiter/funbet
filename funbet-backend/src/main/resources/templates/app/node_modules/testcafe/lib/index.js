...
var getValidHostname = function () {
    var _ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee(hostname) {
        var valid;
...
var getValidPort = function () {
    var _ref2 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee2(port) {
        var isFree;
...
var createTestCafe = function () {
    var _ref3 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee3(hostname, port1, port2) {
        var _ref4;
            ...
            while (1) {
                switch (_context3.prev = _context3.next) {
                    ...
                    case 2:
                        ...
                        port1 = _ref4[1];
                        port2 = _ref4[2];
                        return _context3.abrupt('return', new _testcafe2.default(hostname, port1, port2));
...
// Common API
(0, _keys2.default)(_common2.default).forEach(function (key) {
    createTestCafe[key] = _common2.default[key];
});
