...
var BrowserProvider = function () {
    ...
    BrowserProvider.prototype.init = function init() {
        var _this = this;

        this.initPromise = this.initPromise.then(function (initialized) {
            return initialized ? _pinkie2.default.resolve() : _this.plugin.init();
        }).then(function () {
            return true;
        }).catch(function () {
            return false;
    ...
    BrowserProvider.prototype.dispose = function dispose() {
        var _this2 = this;

        this.initPromise = this.initPromise.then(function (initialized) {
            return initialized ? _this2.plugin.dispose() : _pinkie2.default.resolve();
        }).then(function () {
            return false;
        }).catch(function () {
            return false;
    ...
    BrowserProvider.prototype.openBrowser = function () {
        var _ref9 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee9(browserId, pageUrl, browserName) {
            var isLocalBrowser;
        ...
        function openBrowser(_x16, _x17, _x18) {
    ...
    BrowserProvider.prototype.closeBrowser = function () {
        var _ref10 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee10(browserId) {
    ...
    BrowserProvider.prototype.isValidBrowserName = function () {
        var _ref12 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee12(browserName) {
        ...
        function isValidBrowserName(_x20) {
    ...
    BrowserProvider.prototype.resizeWindow = function () {
        var _ref13 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee13(browserId, width, height, currentWidth, currentHeight) {
            ...
            return _regenerator2.default.wrap(function _callee13$(_context13) {
                while (1) {
                    switch (_context13.prev = _context13.next) {
                        ...
                        case 5:
                            supportedFeatures = _context13.sent;
        ...
        function resizeWindow(_x21, _x22, _x23, _x24, _x25) {
    ...
    BrowserProvider.prototype.canResizeWindowToDimensions = function () {
        var _ref14 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee14(browserId, width, height) {
            var isLocalBrowser, supportedFeatures;
            return _regenerator2.default.wrap(function _callee14$(_context14) {
                while (1) {
                    switch (_context14.prev = _context14.next) {
                        ...
                        case 5:
                            supportedFeatures = _context14.sent;
        ...
        function canResizeWindowToDimensions(_x26, _x27, _x28) {
    ...
    BrowserProvider.prototype.maximizeWindow = function () {
        var _ref15 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee15(browserId) {
            var isLocalBrowser, supportedFeatures;
            return _regenerator2.default.wrap(function _callee15$(_context15) {
                while (1) {
                    switch (_context15.prev = _context15.next) {
                        ...
                        case 2:
                            isLocalBrowser = _context15.sent;
                            _context15.next = 5;
                            return this.plugin.hasCustomActionForBrowser(browserId);

                        case 5:
                            supportedFeatures = _context15.sent;
    ...
    BrowserProvider.prototype.takeScreenshot = function () {
        var _ref16 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee16(browserId, screenshotPath, pageWidth, pageHeight) {
            var isLocalBrowser, supportedFeatures;
        ...
        function takeScreenshot(_x30, _x31, _x32, _x33) {
