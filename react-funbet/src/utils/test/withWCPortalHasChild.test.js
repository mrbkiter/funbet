...
import withWCPortalHasChild from '../withWCPortalHasChild'; // Update the import path

const CORRECT_TAG_NAME = 'test-tag';
describe('withWCPortalHasChild', () => {
  it('renders the portal component when ref.current is available', () => {
    const TestComponent = () => <div>Test Component</div>;
    const PortalComponent = withWCPortalHasChild(TestComponent, {
